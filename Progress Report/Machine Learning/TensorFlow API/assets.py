...
disease_description = [{'Disease': 'Drug Reaction',
...
# 5. Disease and Precautions
disease_precaution = [{'Disease': 'Drug Reaction',
 ...
 {'Disease': 'Diabetes',
  'Precautions': ['have balanced diet',
   'exercise',
   'consult doctor',
   'follow up']},
 {'Disease': 'Impetigo',
 ...
 {'Disease': 'Common Cold',
  'Precautions': ['drink vitamin c rich drinks',
   ...
   'keep fever in check']},
 {'Disease': 'Chicken pox',
  'Precautions': ['use neem in bathing ',
   'consume neem leaves',
   'take vaccine',
   'avoid public places']},
 {'Disease': 'Cervical spondylosis',
  'Precautions': ['use heating pad or cold pack',
   'exercise',
   'take otc pain reliver',
   'consult doctor']},
 {'Disease': 'Hyperthyroidism',
  'Precautions': ['eat healthy',
   'massage',
   'use lemon balm',
 ...
 {'Disease': 'Urinary tract infection',
  'Precautions': ['drink plenty of water',
   ...
   'take probiotics']},
 {'Disease': 'Varicose veins',
  'Precautions': ['lie down flat and raise the leg high',
   'use oinments',
   'use vein compression',
   'dont stand still for long']},
 {'Disease': 'AIDS',
  'Precautions': ['avoid open cuts',
 ...
 {'Disease': 'Typhoid',
  'Precautions': ['eat high calorie vegitables',
   'antiboitic therapy',
   'consult doctor',
   'medication']},
 {'Disease': 'Hepatitis B',
 ...
 {'Disease': 'Migraine',
  'Precautions': ['meditation',
   ...
   'consult doctor']},
 {'Disease': 'Bronchial Asthma',
  'Precautions': ['switch to loose cloothing',
   'take deep breaths',
   'get away from trigger',
   'seek help']},
 {'Disease': 'Alcoholic hepatitis',
  'Precautions': ['stop alcohol consumption',
   'consult doctor',
   'medication',
   'follow up']},
 {'Disease': 'Jaundice',
 ...
 {'Disease': 'Hepatitis E',
  'Precautions': ['stop alcohol consumption',
   ...
   'medication']},
 {'Disease': 'Dengue',
  'Precautions': ['drink papaya leaf juice',
   'avoid fatty spicy food',
   'keep mosquitos away',
   'keep hydrated']},
 {'Disease': 'Hepatitis D',
 ...
 {'Disease': 'Arthritis',
  'Precautions': ['exercise',
   ...
   'massage']},
 {'Disease': 'Gastroenteritis',
  'Precautions': ['stop eating solid food for while',
...
# Cleaning the diseases and the symptoms
disease = []
for i, el in enumerate(diseases_list):
  data = {
    "Id": i,
    "Disease": el
  }
...
for i, el in enumerate(disease_description):
  for x in disease:
    if x['Disease'] == el['Disease']:
      x['Description'] = el['Description']

for i, el in enumerate(disease_precaution):
  for x in disease:
    if x['Disease'] == el['Disease']:
      x['Precautions'] = el['Precautions']
      # x['Precaution_2'] = el['Precaution_2']
      # x['Precaution_3'] = el['Precaution_3']
      # x['Precaution_4'] = el['Precaution_4']

#       precaution_list = []
# for i in list_precautions:
#     data = {}
#     data['Disease'] = i['Disease']
#     precautions = []
#     for x in range(1, 5):
#         if i[f'Precaution_{x}'] != 0:
#             precautions.append(i[f'Precaution_{x}'])
#     data['Precautions'] = precautions
#     precaution_list.append(data)
# precaution_list

symptom = []
for i, el in enumerate(symptoms_list):
  data = {
    "Id": i,
    "Symptom": el
  }
